...
// // import { ExclamationCircleIcon } from "@heroicons/react/20/solid"; // optional heroicons if available
...
//         // this flag assumes reporting_type === "Direct/Indirect" for non-admin. If admin logic differs, adjust.
...
//       // append details to the specific leave request in state
...
//         <h2 className="text-lg font-semibold mb-4">Approve Leaves</h2>
//         <ul className="space-y-2 mb-6">
//           <li>
//             <a href="/dashboard" className="block py-1 hover:underline">
//               Back to Dashboard
//             </a>
//           </li>
//           <li>
//             <a href="/approvalhistoryleaves" className="block py-1 hover:underline">
//               Approval History
//             </a>
//           </li>
//           <li>
//             <a href="/dashboard/calendar_view" className="block py-1 hover:underline">
//               View Calendar
//             </a>
//           </li>
//         </ul>
...
//           <label className="block text-xs mb-1">Filter By</label>
//           <select
//             className="w-full rounded-md p-2 text-sm text-gray-800"
...
//             <div className="mt-3">
//               <label className="block text-xs mb-1">Select Direct Report</label>
//               <select
//                 className="w-full rounded-md p-2 text-sm text-gray-800"
...
//               <div>
//                 <label className="text-sm mr-2">Select All</label>
//                 <input
//                   type="checkbox"
//                   className="h-4 w-4"
...
//                         onClick={(e) => {
//                           // prevent expand when clicking buttons or checkboxes
...
//                         <td className="p-2">{lr.empid}</td>
//                         <td className="p-2">{lr.employee_name}</td>
//                         <td className="p-2">{lr.leave_type}</td>
//                         <td className="p-2">{lr.st_dt}</td>
//                         <td className="p-2">{lr.ed_dt}</td>
//                         <td className="p-2">{Number(lr.total_days).toFixed(1)}</td>
//                         <td className="p-2" title={lr.reason}>
//                           {lr.reason?.length > 20 ? lr.reason.slice(0, 20) + "..." : lr.reason}
//                         </td>
//                         <td className="p-2">{lr.status}</td>
//                         <td className="p-2 whitespace-nowrap">
//                           <button
//                             className="px-2 py-1 mr-2 bg-sky-600 text-white rounded text-xs"
//                             onClick={(e) => {
//                               e.stopPropagation();
...
//                                         <th className="p-1">Half Day</th>
//                                         <th className="p-1">Half Type</th>
//                                       </tr>
//                                     </thead>
//                                     <tbody>
