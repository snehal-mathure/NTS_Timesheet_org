...
//         setLeaves((prev) => prev.map((l) => (l.id === leaveId ? { ...l, status: "Canceled" } : l)));
//       } else {
...
//       {/* Sidebar (keeps existing sidebar component) */}
...
//             {/* Card header */}
//             <div className="flex items-center justify-between px-6 md:px-8 py-5 border-b border-[#eef2ff] bg-white/90">
...
//             {/* Inner content padding adjusted to standard UI */}
...
//                       <div
//                         key={type}
//                         className="bg-white p-4 md:p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-center"
//                       >
//                         <h4 className="text-[11px] font-medium text-slate-500 mb-2 leading-tight">
//                           {type.replace("_", " ").toUpperCase()}
//                         </h4>
//                         <div className="text-2xl md:text-3xl font-semibold text-slate-900">{count}</div>
//                       </div>
//                     ))
//                   ) : (
//                     <div className="col-span-full bg-white p-5 rounded-2xl border border-slate-100 shadow-sm text-center">
//                       <h4 className="text-xs font-medium text-slate-600 mb-1">No balances</h4>
//                       <div className="text-sm text-slate-500">No leave balance data available</div>
//                     </div>
//                   )}
//                 </div>
//               </div>
...
//               <div ref={tableRef} className="bg-white rounded-2xl border border-slate-100 p-4 md:p-6 shadow-sm" aria-live="polite">
//                 {/* Header row with CTA */}
//                 <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
//                   <div>
//                     <h3 className="text-sm md:text-base font-semibold text-slate-800">Leave History</h3>
//                     <div className="text-[12px] text-slate-500 mt-1">{filteredLeaves.length} item(s)</div>
//                   </div>
...
//                     <Link
//                       to="/applyleave"
//                       className="inline-flex items-center gap-2 rounded-2xl text-sm text-white px-4 py-2 font-medium shadow-[0_10px_30px_rgba(76,111,255,0.18)]"
...
//                       className="border border-slate-200 rounded-full px-3 py-1 text-xs bg-[#F8F9FF] focus:ring-1 focus:ring-[#4C6FFF] focus:outline-none"
//                     >
...
//                     <button onClick={resetFilters} className="bg-slate-800 text-white px-3 py-1 rounded-full text-[12px] hover:bg-slate-900">
//                       Reset
//                     </button>
//                   </div>
//                 </div>
...
//                   <table className="min-w-full text-sm md:text-sm divide-y divide-slate-100">
...
//                         <th className="px-4 py-3 text-left font-medium text-slate-600">Applied On</th>
...
//                           const isActionable = status !== "approved" && status !== "canceled" && status !== "cancelled";
//                           return (
//                             <tr key={leave.id} className="hover:bg-slate-50">
//                               <td className="px-4 py-3 whitespace-nowrap">{leave.leave_type || "-"}</td>
//                               <td className="px-4 py-3 whitespace-nowrap">{leave.from_date || "-"}</td>
//                               <td className="px-4 py-3 whitespace-nowrap">{leave.to_date || "-"}</td>
//                               <td className="px-4 py-3 whitespace-nowrap max-w-[20rem] truncate">{leave.reason || "-"}</td>
//                               <td className="px-4 py-3 whitespace-nowrap">{leave.applied_on || "-"}</td>
//                               <td className="px-4 py-3 whitespace-nowrap">
//                                 <span
//                                   className={`font-semibold ${
//                                     status === "pending" ? "text-yellow-600" :
//                                     status === "approved" ? "text-green-600" :
//                                     status.includes("cancel") ? "text-gray-500" : "text-red-600"
//                                   }`}
//                                 >
//                                   {leave.status || "-"}
//                                 </span>
//                               </td>
//                               <td className="px-4 py-3 max-w-[20rem] truncate">{leave.comments || "-"}</td>
//                               <td className="px-4 py-3">
//                                 {isActionable ? (
//                                   <button onClick={() => handleCancelLeave(leave.id)} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-600 hover:bg-rose-700 text-white text-sm font-medium shadow-sm">
//                                     Cancel
//                                   </button>
//                                 ) : (
...
//                       ) : (
//                         <tr>
//                           <td colSpan={8} className="px-4 py-12 text-center text-slate-500 text-sm">No leaves found.</td>
//                         </tr>
//                       )}
//                     </tbody>
//                   </table>
...
//                   <h3 className="text-sm md:text-base font-semibold text-slate-800">Upcoming Holidays</h3>
//                   <div className="text-xs text-slate-500">{holidays?.length ?? 0} item(s)</div>
//                 </div>
...
//                         <th className="px-3 py-2 text-left font-medium text-slate-600">Holiday</th>
...
//                             <td className="px-3 py-2 whitespace-nowrap">{h.start_date || "-"}</td>
//                             <td className="px-3 py-2 whitespace-nowrap">{h.holiday_type || "-"}</td>
//                             <td className="px-3 py-2">{h.holiday_desc || "-"}</td>
//                           </tr>
//                         ))
//                       ) : (
//                         <tr>
//                           <td colSpan={3} className="px-3 py-6 text-center text-slate-500 text-sm">No holidays found.</td>
//                         </tr>
//                       )}
//                     </tbody>
//                   </table>
...
//                   <span className="font-medium">Note:</span> Holidays shown according to company calendar.
//                 </div>
//               </div>
//             </div>
//           </div>
