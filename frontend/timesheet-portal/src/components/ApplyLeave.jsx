              ...
              <form onSubmit={handleSubmit} className="mt-2 grid grid-cols-1 gap-5">
                ...
                <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 mt-4">
                  <div className="flex gap-3">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center gap-2 px-5 py-2 rounded-2xl text-sm font-semibold text-white"
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-2xl text-sm font-medium text-slate-700 border border-[#e0e4ff] bg-white hover:bg-[#f3f5ff]"
                    >
                      Cancel
                    </button>
                  </div>
