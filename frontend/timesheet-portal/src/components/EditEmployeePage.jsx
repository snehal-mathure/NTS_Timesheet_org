        ...
        <div className="max-w-5xl mx-auto space-y-5 mt-4">
          ...
          {success && (
            <div className="rounded-2xl px-4 py-3 text-sm bg-emerald-50 text-emerald-800 border border-emerald-100 flex justify-between">
              <span>{success}</span>
              <button onClick={() => setSuccess("")} className="text-xs underline">
                Dismiss
              </button>
            </div>
          )}
              ...
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-2xl bg-[#F3F5FF] flex items-center justify-center shadow-sm">
                  <svg className="w-6 h-6 text-[#4C6FFF]" fill="none" viewBox="0 0 24 24">
                    <path d="M5 20v-1a4 4 0 014-4h2a4 4 0 014 4v1" stroke="currentColor" strokeWidth="1.6" />
                    <circle cx="12" cy="8" r="3" stroke="currentColor" strokeWidth="1.6" />
                  </svg>
                </div>
                <div>
                  <h2 className="text-lg font-semibold text-slate-900">Edit Employee Details</h2>
                  <p className="text-sm text-slate-500">Modify personal, professional, and client data.</p>
                </div>
              </div>

              <button
                onClick={() => navigate(-1)}
                className="px-4 py-2.5 rounded-2xl border border-[#e0e4ff] bg-white text-xs font-medium text-slate-700 hover:bg-[#f3f5ff]"
              >
                Back
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
                    ...
                    >
                      ...
                      <div className="md:col-span-2 flex gap-2">
                        <button
                          type="button"
                          onClick={() => removeAssignmentRow(idx)}
                          className="bg-red-600 text-white px-4 py-2 rounded-2xl text-xs hover:bg-red-700"
                        >
                          Remove
                        </button>
                      </div>
              ...
              <div className="flex justify-end gap-3 border-t border-[#e5e7f5] pt-4">
                <button
                  type="button"
                  onClick={() => navigate(-1)}
                  className="px-4 py-2 rounded-2xl text-xs font-medium border border-slate-200 bg-white text-slate-700 hover:bg-slate-50"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="px-4 py-2 rounded-2xl text-xs font-semibold text-white shadow-[0_14px_40px_rgba(76,111,255,0.55)]"
                  style={{
