...
//       {/* Sidebar */}
//       <aside className="w-56 bg-sky-800 text-white p-4 fixed inset-y-0 left-0 overflow-auto">
//         <a
//           href="/approveleave"
//           className="block bg-white text-sky-800 rounded-md px-3 py-2 font-semibold mb-4 text-center"
//         >
...
//           <div>
//             <label className="block text-xs text-gray-100 mb-1">Department</label>
//             <select
//               className="w-full rounded p-2 text-sm text-gray-800"
//               value={deptFilter}
...
//           <div>
//             <label className="block text-xs text-gray-100 mb-1">Leave Type</label>
//             <select
//               className="w-full rounded p-2 text-sm text-gray-800"
...
//           <div>
//             <label className="block text-xs text-gray-100 mb-1">Employee</label>
//             <select
//               className="w-full rounded p-2 text-sm text-gray-800"
//               value={empNameFilter}
...
//           <div>
//             <label className="block text-xs text-gray-100 mb-1">Start Date</label>
//             <input
//               type="date"
//               className="w-full rounded p-2 text-sm text-gray-800"
...
//           <div>
//             <label className="block text-xs text-gray-100 mb-1">End Date</label>
//             <input
//               type="date"
//               className="w-full rounded p-2 text-sm text-gray-800"
//               value={endDateFilter}
...
//             <button
//               className="flex-1 bg-white text-sky-800 rounded px-3 py-2 font-semibold"
//               onClick={resetFilters}
//             >
//               Reset
//             </button>
//             <button
//               className="flex-1 bg-sky-600 hover:bg-sky-700 text-white rounded px-3 py-2 font-semibold"
//               onClick={() => { /* filters applied automatically by controlled inputs */ }}
//             >
//               Apply Filter
//             </button>
//           </div>
...
//           <h1 className="text-2xl font-semibold mb-4">Approval History</h1>

//           <div className="flex items-center justify-end mb-3 gap-3">
//             <button
//               className="bg-sky-600 hover:bg-sky-700 text-white rounded px-3 py-2 text-sm"
...
//                     <tr className="hover:bg-gray-50 cursor-pointer" onClick={() => toggleExpand(r)}>
//                       <td className="p-2">{r.employee_name}</td>
//                       <td className="p-2">{r.dept}</td>
//                       <td className="p-2">{r.leave_type}</td>
//                       <td className="p-2">{r.st_dt}</td>
//                       <td className="p-2">{r.ed_dt}</td>
//                       <td className="p-2">{Number(r.total_days).toFixed(1)}</td>
//                       <td className="p-2" title={r.reason}>
//                         {r.reason?.length > 30 ? r.reason.slice(0, 30) + "..." : r.reason}
//                       </td>
//                       <td className={`p-2 font-semibold ${r.status === "Approved" ? "text-emerald-700" : "text-red-600"}`}>
//                         {r.status}
//                       </td>
...
//                           {/* If you have per-day entries for the leave, render them; otherwise show details from the row */}
...
//                             {/* If r.leave_entries exists (array), show table */}
