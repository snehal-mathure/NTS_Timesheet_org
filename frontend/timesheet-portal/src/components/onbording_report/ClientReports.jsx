...
export default function ClientReports() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log("Data from service:", reportData);
  ...
  return (
    <div className="max-w-5xl mx-auto">
      {/* Heading – same style as other onboarding pages */}
      <div className="mb-5">
      ...
      <div className="bg-white/90 border border-[#e5e7f5] rounded-3xl shadow-[0_24px_60px_rgba(15,23,42,0.12)] overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-[#e5e7f5] bg-[#F3F5FF]">
          <p className="text-[11px] md:text-xs text-slate-500">
            Tip: Use this report to understand how your teams are allocated
            across different clients and departments.
          </p>
        </div>
      </div>
    </div>
