...
#         df["password"] = None   # NOT empty string
#     return df
...
# def has_changes(emp, updates: dict):
...
#             # Dates only if present in Excel
#             if pd.notna(row.doj):
#                 updates["doj"] = doj
#             if pd.notna(row.lwd):
#                 updates["lwd"] = lwd
