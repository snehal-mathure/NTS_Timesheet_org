...
def export_employees():
    ...
    query = (
        Employee_Info.query
        .outerjoin(Department, Employee_Info.dept_id == Department.id)
        .outerjoin(JobRole, Employee_Info.job_role_id == JobRole.id)
    )
    ...
    # ================= HEADER (NOTHING REMOVED, ONLY ADDED) =================
    writer.writerow([
        'Emp ID', 'Emp Name', 'Gender', 'Emp Type', 'Location', 'Company',
        'Work Location', 'Country', 'City', 'Mobile', 'Email', 'Designation',
        'Approver', 'Secondary Approver',
        'Core Skill', 'Skills Details',
        'Experience on DOJ', 'Total Experience as on Date',
        'Previous Total Experience',
        'NTS Emp DOJ', 'NTS Emp LWD',
        'Department',
        'Job Role', 'Job Role ID',
        'Full name of client',
        'Client Start Date', 'Client End Date',
    ...
    for emp in employees:
        ...
        job_role_name = emp.job_role.job_role if emp.job_role else ""
        job_role_id = emp.job_role_id or ""
        ...
        base_row = [
            ...
            emp.designation or "",
            emp.approver_id or "",
            emp.secondary_approver_id or "",
            emp.core_skill or "",
            emp.skill_details or "",
            exp_on_doj,
            total_exp,
            emp.prev_total_exp if emp.prev_total_exp is not None else "",
            ...
            for ca in client_assignments:
                ...
                if ca.clientID:
                    ...
                    if client_info:
                        ...
                        daily_hours = str(Project_Info.daily_hours or "")
